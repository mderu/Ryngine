lexer grammar RenpyLexer;

// Source for most of this: https://github.com/antlr/grammars-v4/blob/master/python/python3_12/RenpyLexer.g4
// At the time of writing, this code was under the MIT License.
