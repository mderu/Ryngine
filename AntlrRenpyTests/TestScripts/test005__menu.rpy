...
menu expectedMenuLabel:
	...
	"When the choice is selected, the block of statements is run":
		# If execution reaches the end of the block it continues with the statement after
		# the end of the menu statement. In other words, selecting the first choice won't
		# show messages from this choice.
		"Message that only appears in the second choice."
		pass
